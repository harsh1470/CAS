...
<div class="card" id="registerCandidate">
                ...
                <h3 class="card-title text-center text-dark">Register Candidates List</h3>
                ...
                <table id="example" class="table table-bordered table-striped">
                  ...
                  <tbody>
						<c:choose>
							...
							<c:otherwise>
								<c:forEach items="${allRegisterCandidates}" var="cand" varStatus="count">
									<tr>
										<td>${count.count}</td>
...
$(function () {
    var table = $("#example").DataTable({
        ...
        "lengthMenu": [ [5,10, 25, 50, -1], [5,10, 25, 50, "All"] ], // Define the options for the dropdown
        "autoWidth": false,
        "buttons": ["excel"]
    });

    // Append the buttons container and length change dropdown to the desired location
